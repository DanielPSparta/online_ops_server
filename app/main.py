...
# @transfers #sqlinjection from #login to #sql_server with developer not checking the input
...
# @transfers #brute from #login to #sql_server with developer not checking the input
